...
public class Pregunta4 extends javax.swing.JPanel {
    ...
    public Pregunta4() {
        ...
        p5 = new Pregunta5();
        this.hobbies.RespuestasHobbies = new ArrayList<Double>();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Pregunta 4 ¿Disfrutaste de tiempo libre o hobbies el día de hoy?");
    ...
    this.hobbies.RespuestasHobbies.add(respuesta);
    // Agregar respuesta a la lista y escribir en el archivo
    registro.guardarRespuesta(respuesta);
    registro.escribirRespuestasEnArchivo("Respuestas Tiempo Libre Hobbies");
    
    RegistroDatosBinario.agregarRespuesta(respuesta);
    RegistroDatosBinario.escribirRespuestasEnArchivoBinario("Respuestas Tiempo Libre Hobbies");
