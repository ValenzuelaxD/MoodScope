...
public class Pregunta8 extends javax.swing.JPanel {
    ...
    public Pregunta8() {
        ...
        //p8 = new Pregunta8();
        this.suenio.RespuestasSuenio = new ArrayList<Double>();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Pregunta 8 ¿Sentiste que tu sueño fue de calidad y suficiente?");
    ...
    this.suenio.RespuestasSuenio.add(respuesta);
    RegistroDatos.guardarRespuesta(respuesta);
    RegistroDatos.escribirRespuestasEnArchivo("Respuestas Suenio");
    
    RegistroDatosBinario.agregarRespuesta(respuesta);
    RegistroDatosBinario.escribirRespuestasEnArchivoBinario("Respuestas Suenio");
