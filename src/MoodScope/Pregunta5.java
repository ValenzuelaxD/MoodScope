...
public class Pregunta5 extends javax.swing.JPanel {
    ...
    public Pregunta5() {
        ...
        p6 = new Pregunta6();
        this.social.RespuestasSocial = new ArrayList<Double>();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Pregunta 5 ¿Conviviste con tus seres queridos el día de hoy?");
    ...
    this.social.RespuestasSocial.add(respuesta);
    // Agregar respuesta a la lista y escribir en el archivo
    registro.guardarRespuesta(respuesta);
    registro.escribirRespuestasEnArchivo("Respuestas Social");
    
    RegistroDatosBinario.agregarRespuesta(respuesta);
    RegistroDatosBinario.escribirRespuestasEnArchivoBinario("Respuestas Social");
