...
public class Pregunta3 extends javax.swing.JPanel {
    ...
    public Pregunta3() {
        ...
        this.saludFisica.RespuestasSaludFisica = new ArrayList<Double>();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Pregunta 3 ¿Cómo te sentiste de salud durante el día?");
...
try {
    ...
    this.saludFisica.RespuestasSaludFisica.add(respuesta);
    RegistroDatos.guardarRespuesta(respuesta);
    RegistroDatos.escribirRespuestasEnArchivo("Respuestas Salud Fisica");
    
    RegistroDatosBinario.agregarRespuesta(respuesta);
    RegistroDatosBinario.escribirRespuestasEnArchivoBinario("Respuestas Salud Física");
