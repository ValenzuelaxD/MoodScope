...
public class Pregunta1 extends javax.swing.JPanel {
    ...
    public Pregunta1() {
        initComponents();
        RegistroDatos registro = General.registro;
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Pregunta 1: ¿Cómo fue tu alimentación el día de hoy? ");
        ...
        btn4.setText("4 Buena");

        btn5.setText("5 Muy Buena");
...
try {
    ...
    this.alimentacion.RespuestasAlimentacion.add(respuesta);
    
    
    RegistroDatos.guardarRespuesta(respuesta);
    RegistroDatos.escribirRespuestasEnArchivo("Respuestas Alimentacion");

    RegistroDatosBinario.agregarRespuesta(respuesta);
    RegistroDatosBinario.escribirRespuestasEnArchivoBinario("Respuestas Alimentacion");
    ...
    showMessageDialog(null, "Error: Favor de seleccionar una respuesta");
}
